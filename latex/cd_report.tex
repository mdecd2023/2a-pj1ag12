...
\hspace{32mm}\makebox[5cm][s]
{學\qquad 生：\quad 第\quad 一\quad 位\quad(41023126)}
\\[6pt]
\hspace{32mm}\makebox[5cm][s]
{\hspace{36.5mm}第\quad 二\quad 位\quad(41023114)}\\[6pt]
\hspace{32mm}\makebox[5cm][s]
...
%=---------------報告製作核可證明---------------------=%
 ...
 {\begin{center}
    ...
    {\begin{minipage}[t]{10em}\underline{四設二甲\enspace 41023126 第一位}\\ \underline{四設二甲\enspace 41023114\enspace 第二位}\\ \underline %下劃線符號指令
    \end{minipage}}
         \par} %結束指定行距
