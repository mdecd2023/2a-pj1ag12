...
%=---------------報告製作核可證明---------------------=%
 ...
 {\begin{center}
    ...
    \noindent \fontsize{15pt}{16pt}\selectfont 分組報告製作修習學生\enspace:\quad
           {\begin{minipage}[t]{10em}\underline{四設二甲\enspace 41023114 王樟皓}\\ \underline{四設二甲\enspace 41023126\enspace 卓桓琮}\\ %下劃線符號指令
    \end{minipage}}
         \par} %結束指定行距
...
%=-------------作者簡介-----------------=%
    ...
    \fontsize{14pt}{0em}\selectfont \makebox[9em][s]{大甲高工}\\
